...
RDBMS is the software used to manage the database, while sql is the language used to interact with the database. 

1. Why do tables need a `primary key`?
Tables need a primary key in order to identify themselves, incase you need to link it to another table.

1. What is the name given to a table column that references the primary key on another table.
It is called a foreign key.

1. What do we need in order to have a _many to many_ relationship between two tables.
To have a many to many relationship, we need a third table that links the primary keys from both tables.
## Project Set Up
